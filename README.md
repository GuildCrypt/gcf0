...
| [`constructor(uint256,uint256,address,address,uint256,uint256,uint256)`](#constructor(uint256,uint256,address,address,uint256,uint256,uint256)) | constructor |
...
| `0` | `uint256` |  |  |
---
#### <a name="constructor(uint256,uint256,address,address,uint256,uint256,uint256)"></a> `constructor(uint256,uint256,address,address,uint256,uint256,uint256)`
##### Inputs
|  | Type | Name | Description |
|---|---|---|---|
...
| `4` | `uint256` | `__minAuctionCompleteWait` |  |
| `5` | `uint256` | `__minBidDeltaPermille` |  |
| `6` | `uint256` | `__totalSupply` |  |
---
