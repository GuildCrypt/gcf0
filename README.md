...
Determine if in sunset buffer period (and thus anyone can start an auction)
##### Outputs
|  | Type | Name | Description |
|---|---|---|---|
| `0` | `bool` |  |  |
...
Submit a bid. Must have sufficient funds approved in `dai` contract
##### Inputs
|  | Type | Name | Description |
|---|---|---|---|
| `0` | `uint256` | `_bid` | Amount in `dai` to bid |
---
...
Get `sunsetInitiatedAt` of the `OathForge` token
##### Outputs
|  | Type | Name | Description |
|---|---|---|---|
| `0` | `uint256` |  |  |
